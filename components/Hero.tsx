    ...
    >
      ...
      <div className="container-custom grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div className="flex flex-col items-start z-10">
          <span
            ref={eyebrowRef}
            className="text-[12px] text-accent font-semibold tracking-tight uppercase mb-6"
          >
            Custom Web Design · Where Details Matter
          </span>
          <h1
            ref={h1Ref}
            className="text-5xl md:text-6xl lg:text-[82px] font-extrabold text-white leading-[1.05] mb-8 tracking-tight font-[family-name:var(--font-jakarta)]"
          >
        ...
        <div
          ref={imageRef}
          className="group relative aspect-[4/3] lg:aspect-square w-full py-4"
        >
