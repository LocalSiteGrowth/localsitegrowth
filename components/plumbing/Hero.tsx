    ...
    >
      ...
      <div className="container-custom grid lg:grid-cols-2 items-center gap-12 lg:gap-20">
        <div className="relative z-10">
          <h1 
            ref={h1Ref}
            className="text-[48px] md:text-[58px] lg:text-[72px] font-bold text-white leading-[1.05] mb-6 flex flex-col font-serif"
          ...
          >
            ...
            <span className="h1-line text-white"><span style={{ color: "var(--accent-color)" }}>Real</span> Results.</span>
          </h1>
